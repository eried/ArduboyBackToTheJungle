unsigned char const intro1[] PROGMEM  = "%%%%%%Hey guys,% I_guess we are_all aware_that our Zoo_had to close_...\0";
...
unsigned char const playing41[] PROGMEM  = "Now the_prettiest,_strongest,_handsomest_and heroic_of all!\0";
unsigned char const playing5[] PROGMEM  = "Nice! I did_it!, now the_lion! be_careful.\0";
unsigned char const playing6[] PROGMEM  = "Awesome, we_are almost_there. Now_here I come!\0";
unsigned char const playing7[] PROGMEM  = "That was_close. Now_is the turn_of the_elephant.\0";
...
unsigned char const playing91[] PROGMEM  = "The jungle_looks as I_remember!_Except that_misterious_artifact.%%%\0";
unsigned char const playing92[] PROGMEM  = "Which one?_That glowing_menacing_box in the_middle of our_jungle?%%%\0";
unsigned char const playing93[] PROGMEM  = "Yes, that_one.%%%%%\0";
unsigned char const playing94[] PROGMEM  = "Looks evil,_like time_\"travelly\",_Nobody touch_it---\0";
